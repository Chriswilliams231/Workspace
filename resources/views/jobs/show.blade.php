<x-layout>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div x-cloak x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900/50">
                            <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                                ...
                                <form method="POST" action="{{ route('applicant.store', $job->id) }}"
                                    ...
                                    @csrf
                                    <x-inputs.text id="fullname" name="fullname" label="Full Name" :required="true" />
                                    ...
                                    <x-inputs.text id="location" name="location" label="Loaction" />
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            {{-- Bookmark Button --}}
            @guest
                <p class="mt-10 bg-gray-200 text-gray-700 font font-bold w-full py-2 px-4 rounded-ful text-center">
                    <i class="fas fa-info-circle mr-3"></i> Login to bookmark
                </p>
            @else
                <form method="POST"
